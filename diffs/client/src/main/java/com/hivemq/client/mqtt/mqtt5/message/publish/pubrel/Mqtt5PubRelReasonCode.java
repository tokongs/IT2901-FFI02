...
index 2db5a1d..0000000
--- a/client/src/main/java/com/hivemq/client/mqtt/mqtt5/message/publish/pubrel/Mqtt5PubRelReasonCode.java
+++ /dev/null
@@ -1,77 +0,0 @@
-/*
...
-
-/**
- * Reason Code of an {@link Mqtt5PubRel MQTT 5 PubRel message}.
- *
- * @author Silvio Giebl
- * @since 1.0
- */
