...
index e7e5a46..0000000
--- a/client/src/main/java/com/hivemq/client/mqtt/mqtt3/message/ping/Mqtt3PingReq.java
+++ /dev/null
@@ -1,37 +0,0 @@
-/*
...
-
-/**
- * MQTT 3 PingReq message. This message is translated from and to an MQTT 3 PINGREQ packet.
- *
- * @author Silvio Giebl
- * @since 1.0
- */
