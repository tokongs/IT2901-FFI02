...
index 8e2aa05..0000000
--- a/client/src/main/java/com/hivemq/client/mqtt/mqtt5/message/publish/pubrec/Mqtt5PubRec.java
+++ /dev/null
@@ -1,56 +0,0 @@
-/*
...
-
-/**
- * MQTT 5 PubRec message. This message is translated from and to an MQTT 5 PUBREC packet.
- *
- * @author Silvio Giebl
- * @since 1.0
- */
