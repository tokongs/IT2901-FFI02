...
index f8dbf11..0000000
--- a/client/src/test/java/com/hivemq/client/internal/mqtt/message/publish/pubrel/MqttPubRelTest.java
+++ /dev/null
@@ -1,38 +0,0 @@
-/*
...
-    @Test
-    void equals() {
-        EqualsVerifier.forClass(MqttPubRel.class)
