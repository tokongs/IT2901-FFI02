...
index 21f5e36..0000000
--- a/client/src/test/java/com/hivemq/client/internal/mqtt/message/publish/pubcomp/MqttPubCompTest.java
+++ /dev/null
@@ -1,38 +0,0 @@
-/*
...
-    @Test
-    void equals() {
-        EqualsVerifier.forClass(MqttPubComp.class)
