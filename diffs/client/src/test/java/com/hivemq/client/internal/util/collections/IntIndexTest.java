...
index ec70728..0000000
--- a/client/src/test/java/com/hivemq/client/internal/util/collections/IntIndexTest.java
+++ /dev/null
@@ -1,350 +0,0 @@
-/*
...
-        final IntIndex<Entry> map = new IntIndex<>(new IntIndex.Spec<>(e -> e.id));
