...
index d0d34b8..0000000
--- a/broker/src/main/java/com/hivemq/persistence/ProducerQueues.java
+++ /dev/null
@@ -1,332 +0,0 @@
-/*
...
-
-    public ProducerQueues(final SingleWriterService singleWriterService, final int amountOfQueues) {
...
-        if (shutdown.get() && System.currentTimeMillis() - shutdownStartTime > singleWriterService.getShutdownGracePeriod()) {
...
-        if (!ignoreShutdown && shutdown.get() && System.currentTimeMillis() - shutdownStartTime > singleWriterService.getShutdownGracePeriod()) {
...
-                               @Nullable final SingleWriterService.SuccessCallback<T> successCallback,
-                               @Nullable final SingleWriterService.FailedCallback failedCallback) {
-            this.future = future;
-            this.task = task;
