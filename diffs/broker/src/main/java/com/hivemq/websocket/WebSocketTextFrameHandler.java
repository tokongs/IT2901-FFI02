...
index dc739d8..0000000
--- a/broker/src/main/java/com/hivemq/websocket/WebSocketTextFrameHandler.java
+++ /dev/null
@@ -1,45 +0,0 @@
-/*
...
-                    "Disconnecting client with IP{}.", ChannelUtils.getChannelIP(channel));
-        }
-    }
-}
