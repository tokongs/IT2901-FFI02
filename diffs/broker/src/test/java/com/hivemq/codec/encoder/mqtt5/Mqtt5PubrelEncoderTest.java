...
index c82b2b0..0000000
--- a/broker/src/test/java/com/hivemq/codec/encoder/mqtt5/Mqtt5PubrelEncoderTest.java
+++ /dev/null
@@ -1,354 +0,0 @@
-/*
...
-
-    private Mqtt5PubrelEncoder encoder;
-
-    @Before
...
-        encoder = new Mqtt5PubrelEncoder(messageDroppedService, securityConfigurationService);
-        super.setUp(encoder);
-
-    }
-
...
-        encodeTestBufferSize(expected, pubRel, encoder.bufferSize(channel.pipeline().context(encoder), pubRel));
-    }
-
-    @Test
