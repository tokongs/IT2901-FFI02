...
index d74ce92..0000000
--- a/broker/src/test/java/com/hivemq/codec/decoder/mqtt5/Mqtt5PubrecDecoderTest.java
+++ /dev/null
@@ -1,573 +0,0 @@
-/*
...
-
-    private final Mqtt5PubRecReasonCode reasonCode = Mqtt5PubRecReasonCode.SUCCESS;
-
-    @Test
...
-
-    @NotNull
-    private PUBREC decode(final byte[] encoded) {
-        final ByteBuf byteBuf = channel.alloc().buffer();
