...
index 02888fb..0000000
--- a/broker/src/test/java/com/hivemq/codec/encoder/mqtt5/Mqtt5ConnackEncoderTest.java
+++ /dev/null
@@ -1,1309 +0,0 @@
-/*
...
-
-        channel.attr(ChannelAttributes.MAX_PACKET_SIZE_SEND).set(150L);
-
-        final byte[] expected = {
-                // fixed header
-                //   type, flags
