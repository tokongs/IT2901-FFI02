...
index 7cb24ab..0000000
--- a/broker/src/test/java/com/hivemq/extensions/handler/PluginAuthorizerServiceImplTest.java
+++ /dev/null
@@ -1,537 +0,0 @@
-/*
...
-                getTestAuthorizerProvider("TestAuthorizerForgetProvider", authorizeLatch1),
-                "plugin2",
-                getTestAuthorizerProvider("TestAuthorizerForgetProvider", authorizeLatch2)));
-
-        final SUBSCRIBE fullMqtt5Subscribe = TestMessageUtil.createFullMqtt5Subscribe();
-
-        pluginAuthorizerService.authorizeSubscriptions(channelHandlerContext, fullMqtt5Subscribe);
